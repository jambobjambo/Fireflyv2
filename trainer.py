...
train_i, test_i = pickle.load(open(pickle_directory + '/Attributes/' + '0.pickle', 'rb'))
	...
	with tf.Session() as sess:
		...
		for epoch in range(training_epochs):
			...
			for file in files:
				...
				train_intent, test_intent = pickle.load(open('./DataForML/Attributes/' + file, 'rb'))
