...
train_pl, test_pl = pickle.load(open(pickle_directory + '/Places/' + '0.pickle', 'rb'))

n_nodes_hl1 = 1500
n_nodes_hl2 = 1500
n_nodes_hl3 = 1500

n_classes = len(train_pl[0])
batch_size = 100
hm_epochs = 5
	...
	with tf.Session() as sess:
		...
		for epoch in range(hm_epochs):
			...
			for file in files:
				...
				train_calendar, test_calendar = pickle.load(open(pickle_directory + '/Places/' + file, 'rb'))
				i=0
			...
			print('Epoch', epoch+1, 'completed out of',hm_epochs,'Loss:',epoch_loss,"Accuracy:", accuracy.eval({x: test_q, y: test_pl}))
			saver.save(sess, "../Checkpoints/Places/model.ckpt")
